...
public class EmargementReglementTitrePK implements Serializable {
    ...
    public EmargementReglementTitrePK(int numDom, Date dateDom, short codeTitre) {
        this.numDom = numDom;
    ...
    public String toString() {
        return "services.beans.Domi.EmargementReglementTitrePK[ numDom=" + numDom + ", dateDom=" + dateDom + ", codeTitre=" + codeTitre + " ]";
    }

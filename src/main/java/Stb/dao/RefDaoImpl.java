...
public class RefDaoImpl implements RefDao {
    ...
    public String oneBanque(Short codeBanque) throws Exception {
        ...
        String libelle = ((Banque) session.get(Banque.class, codeBanque)).getLibBanque();
        session.close();
        return libelle;
    ...
    public String oneAgence(Short codeAgenceBct, Short codeBanque) throws Exception {
        session = sessionFactory.openSession();
        String libelle = ((Agence) session.get(Agence.class, new AgencePK(codeBanque, codeAgenceBct))).getLibAgence();
        session.close();
        return libelle;
    }
...
//    }
    ...
    public List<Devise> allDevise() {
        ...
        List<Devise> devises = query.list();
        session.close();
        return devises;
    }
    ...
    public Devise sigleDevise(Integer codeDevise) throws Exception {
        session = sessionFactory.openSession();
        Devise devise = ((Devise) session.get(Devise.class, codeDevise));
        session.close();
        return devise;
...
//    }
    ...
    public Agence getAgence(short codeBanque, short codeAgenceBct) {
        session = sessionFactory.openSession();
        Query query = session.getNamedQuery("Agence.findByCodeBanqueAndCodeAgence");
